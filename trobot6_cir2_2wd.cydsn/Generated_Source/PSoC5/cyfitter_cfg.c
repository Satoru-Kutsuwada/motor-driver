...
#define BS_UDB_0_5_1_CONFIG_VAL ((const uint8 CYFAR *)0x480011F0u)
...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48001288u)

/* IOPINS1_7 Address: CYREG_PRT12_DR + 0x0000000Bu Size (bytes): 5 */
#define BS_IOPINS1_7_VAL ((const uint8 CYFAR *)0x48001294u)
...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x480012A8u)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x480012CCu)

/* IOPINS0_5 Address: CYREG_PRT5_DR Size (bytes): 10 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x480012D8u)

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x480012E4u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0), 0x001Fu);
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG4_CFG0), 0x008Au);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW0, 0xB0u);
...
uint8 CYXDATA * const CYCODE AMux_1__addrTable[16] = {
	(uint8 CYXDATA *)CYREG_PRT2_AG, (uint8 CYXDATA *)CYREG_SAR1_SW0, 
	(uint8 CYXDATA *)CYREG_PRT4_AG, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT4_AG, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT4_AG, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_1__maskTable[16] = {
	0x02u, 0x02u, 
	0x20u, 0x00u, 
	0x10u, 0x00u, 
	0x08u, 0x00u, 
