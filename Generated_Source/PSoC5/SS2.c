...
{
    uint8 staticBits = (SS2_DR & (uint8)(~SS2_MASK));
    SS2_DR = staticBits | ((uint8)(value << SS2_SHIFT) & SS2_MASK);
}
...
{
	CyPins_SetPinDriveMode(SS2_0, mode);
}
...
uint8 SS2_Read(void)
{
    return (SS2_PS & SS2_MASK) >> SS2_SHIFT;
}
...
{
    return (SS2_DR & SS2_MASK) >> SS2_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(SS2_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & SS2_0_INTR) != 0u) 
		{ 
			 SS2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (SS2_INTSTAT & SS2_MASK) >> SS2_SHIFT;
    }
