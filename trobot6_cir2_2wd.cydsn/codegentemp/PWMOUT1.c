...
{
    uint8 staticBits = (PWMOUT1_DR & (uint8)(~PWMOUT1_MASK));
    PWMOUT1_DR = staticBits | ((uint8)(value << PWMOUT1_SHIFT) & PWMOUT1_MASK);
}
...
{
	CyPins_SetPinDriveMode(PWMOUT1_0, mode);
}
...
{
    return (PWMOUT1_PS & PWMOUT1_MASK) >> PWMOUT1_SHIFT;
}
...
{
    return (PWMOUT1_DR & PWMOUT1_MASK) >> PWMOUT1_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(PWMOUT1_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & PWMOUT1_0_INTR) != 0u) 
		{ 
			 PWMOUT1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (PWMOUT1_INTSTAT & PWMOUT1_MASK) >> PWMOUT1_SHIFT;
    }
