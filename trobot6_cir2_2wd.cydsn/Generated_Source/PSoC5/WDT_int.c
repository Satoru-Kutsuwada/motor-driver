...
void WDT_int_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)WDT_int__INTC_NUMBER] = address;
}
...
cyisraddress WDT_int_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)WDT_int__INTC_NUMBER];
}
